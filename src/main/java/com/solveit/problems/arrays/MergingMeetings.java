...
public class MergingMeetings {
    ...
    public static List<Meeting> mergeRanges(List<Meeting> meetings) {
                    ...
                    // Sort
                    // Initialize lb, ub, and result
                    // iterate
                    // if new LB b/n exisitng >> create a new pair and move to result
        // else move the new node directly to result
        // Get all values of result map and return
        ...
        for(Meeting currentMeeting: meetings) {
            ...
            if(currentMeeting.getStartTime() <= lastMergedMeeting.getEndTime()) {
                ...
                if(endTime < lastMergedMeeting.getEndTime()){
                    endTime = lastMergedMeeting.getEndTime();
                }

                lastMergedMeeting.setEndTime(endTime);
            } else {
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(MergingMeetings.class);
