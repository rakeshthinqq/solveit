...
public class ReverseWordsInCharArray {
    ...
    public static void reverseWords(char[] message) {
        ...
        int head = 0;
        int tail = message.length -1;
        reverse(head, tail, message);
    ...
    private static void reverse(int head, int tail, char[] message) {
        while(head < tail) {
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(ReverseWordsInCharArray.class);
